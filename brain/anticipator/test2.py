...
if __name__ == "__main__":
    ...
    # pre-process starts
    fusion_data["LCB_UP_QTY"] = fusion_data["10_Bin17_LCB(center)"] + fusion_data["11_Bin18_LCB(edge)"] + fusion_data["12_Bin19_LCB(corner)"] + fusion_data["76_Bin22_LCBraw"] + fusion_data["77_Bin23_LCBaccum"]
    fusion_data["LCB_DOWN_QTY"] = fusion_data["01_Bin17_LCB(center)"]+fusion_data["02_Bin18_LCB(edge)"]+fusion_data["03_Bin19_LCB(corner)"]+fusion_data["77_Bin22_LCBraw"]+fusion_data["78_Bin23_LCBaccum"]+fusion_data["79_Bin25_LCB_Retest_Count"]
